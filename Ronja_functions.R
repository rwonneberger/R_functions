...
manhattan_style <- list(theme_bw() + labs(x="Position (Mbp)",y="-log10(pval)") +   theme(legend.position = "none") + theme(axis.text.x =element_text(angle = 90)) + facet_grid(~chrom, scales="free_x", space = "free_x"))
